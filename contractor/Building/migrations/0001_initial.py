...
class Migration(migrations.Migration):
    ...
    operations = [
        migrations.CreateModel(
            ...
            options={'default_permissions': ('view', 'change', 'delete'), 'permissions': (('can_create_foundation', 'Can Create Foundations'),)},
        ),
        migrations.CreateModel(
        ...
        migrations.CreateModel(
            ...
            fields=[
                ...
                ('id_map', contractor.fields.JSONMapField(blank=True, default=None, null=True)),
                ('located_at', models.DateTimeField(null=True, editable=False, blank=True)),
                ('built_at', models.DateTimeField(null=True, editable=False, blank=True)),
                ('updated', models.DateTimeField(auto_now=True)),
                ('created', models.DateTimeField(auto_now_add=True)),
            ],
            options={'default_permissions': ('view', 'change', 'delete'), 'permissions': (('can_create_foundation_job', 'Can Create Foundation Jobs'), ('can_bootstrap', 'Can send bootstrap info'))},
        ),
    ]
